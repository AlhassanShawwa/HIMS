        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    {{ __('doctors.update_password') }} {{$doctor->name}}</h5>
            ...
            <form action="{{ route('update_password') }}" method="post" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="password">{{ __('doctors.new_password') }}</label>
                        <input type="password" class="form-control" id="password" name="password" >
                    </div>

                    <div class="form-group">
                        <label for="password_confirmation">{{ __('doctors.confirm_password') }}</label>
