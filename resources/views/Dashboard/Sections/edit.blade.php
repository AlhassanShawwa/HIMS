    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('Dashboard/sections_trans.edit_sections')}}</h5>
            ...
            <form action="{{ route('Sections.update', 'test') }}" method="post">
                ...
                <div class="modal-body">
                    <label for="exampleInputPassword1">{{__('Dashboard/sections_trans.name_sections')}}</label>
